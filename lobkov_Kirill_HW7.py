...
def add_products(conn):
    ...
    create_products(connection, ('mayonnaise', 100, 20))
    create_products(connection, ('pepsi', 30, 15))
    create_products(connection, ('sprite', 400, 5))
    create_products(connection, ('apple', 50, 25))
    create_products(connection, ('ice scream ', 250, 6))
    create_products(connection, ('milk ', 50, 10))
    create_products(connection, ('cocoa', 125, 5))
    create_products(connection, ('meat', 500, 5))
    create_products(connection, ('air freshener', 20.00, 100))
    create_products(connection, ('ketchup', 65.00, 3))
    create_products(connection, ('zucchini ', 400, 5))
    create_products(connection, ('cakes ', 400, 5))
    create_products(connection, ('cheese ', 400, 5))
    create_products(connection, ('pizza', 400, 5))
    create_products(connection, ('water ', 400, 5))
    create_products(connection, ('rice ', 400, 5))
